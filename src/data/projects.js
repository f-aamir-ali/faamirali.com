...
export const projects = [
  {
    ...
    cardLine: 'An AI assistant I built and deployed at my school to instantly answer everyday questions for students and staff.',
    ...
    acts: [
      {
        ...
        paras: [
          "Every school buries the things students actually need — the daily schedule, who teaches what, which clubs exist — inside PDFs nobody opens. FleetBot answers those questions in plain English, straight from the school's own documents. I built the whole thing myself and launched it school-wide through the AI Club's Instagram.",
          'The real challenge was making it cheap and reliable enough to run for an entire school at once. I engineered the whole public beta to cost $2.76 in total — hundreds of messages, zero errors — and wrote the rules that stop it from ever guessing an answer or replying to anything unsafe.',
        ],
      },
      {
        ...
        paras: [
          "The student launch proved it worked, so I pitched the principal a version for staff. The hard part wasn't the code — it was trust. A school won't run a student's AI unless it's certain the information stays private, so I rebuilt it to keep everything under the school's own control. That's what earned the green light.",
    ...
    ledger: [
      ...
      {
        n: '$2.76',
        l: 'total cost to run the entire student beta — hundreds of messages, zero errors',
...

  {
    ...
    seoDescription:
      'The first youth AI summit in Surrey — a one-day event I planned and executed: ~70 students from 14 schools, a real sponsor, professional judges, and a UBC keynote, building and pitching working AI in a single day.',
    ogImage: '/og/surrey-ai-summit.png',
    tagline:
      '~70 students. 14 schools. One day to build real AI for local businesses — the first youth AI summit in Surrey.',
    acts: null,
    intro: [
...

  {
    ...
    fileLine: 'Active — founded September 2025 · Founder & president',
    // Plain, one-sentence summary for the home card — no jargon, not truncated.
    ...
    seoDescription:
      'The club I founded to teach students to build with AI — 20 members, a real build every meeting, and 22 members who made AI videos for a national Best Buy challenge against 40+ schools across Canada.',
    ...
    acts: null,
    intro: [
      'I started the club in September 2025, after building FleetBot showed me how few students actually knew how to build with AI. Every meeting is hands-on — members use no-code tools to build real websites, automations, and chatbots, and leave having shipped something that works instead of just watching a slideshow.',
      "When the Best Buy Teen Tech “Create with AI” Challenge (run with Microsoft) let each school enter once, I opened it up as an internal contest instead of hand-picking a few people — so 22 members ended up making AI videos, and our winning entry represented the school against more than 40 others across Canada.",
    ],
    ledger: [
      {
        n: '20',
